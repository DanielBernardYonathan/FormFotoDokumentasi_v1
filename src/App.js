...
function App() {
  ...
  const [formData, setFormData] = useState({
    namaToko: "", kodeToko: "", tanggalGo: "", spkAwal: "", kontraktorSipil: "",
    cabang: "", tanggalSt: "", tanggalAmbilFoto: "", spkAkhir: "", kontraktorMe: "",
  })
  ...
  const handleFormSubmit = (data) => { setFormData(data); setCurrentStep(2) }
      ...
      <header className="app-header">
        <div className="header-content">
          ...
          <div style={{position:"absolute", right:16, top:12}}>
            <button className="btn-secondary" onClick={()=>{ logout(); window.location.reload(); }}>
              Logout
            </button>
          </div>
        </div>
